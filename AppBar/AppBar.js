      ...
      if (iconElementRight) {
        ...
        switch (iconElementRight.type.muiName) {
          ...
          case 'IconButton':
            ...
            var iconButtonIconStyle = !(iconElemRightChildren && iconElemRightChildren.props && iconElemRightChildren.props.color) ? styles.iconButtonIconStyle : null;

            iconElementRightNode = _react2.default.cloneElement(iconElementRight, {
              iconStyle: (0, _simpleAssign2.default)({}, iconButtonIconStyle, iconElementRight.props.iconStyle)
            });
            break;
